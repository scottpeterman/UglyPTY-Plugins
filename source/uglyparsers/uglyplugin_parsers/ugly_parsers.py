...
from uglyplugin_parsers.Library.parser_examples import p_examples
from ttp import ttp
from jinja2 import Template
import yaml
import json
import jmespath
from uglyplugin_parsers.Library.HighlighterTEWidget import SyntaxHighlighter
...
class UglyParsingWidget(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.teSource.setFont(font)
        self.teTemplate.setFont(font)
        ...
        self.teResult.setMinimumWidth(300)
    ...
    def highlighterComboBoxChanged(self, index):
        ...
        if index == 1:  # Keywords Highlighter
            ...
            filename = os.path.join(base_dir, './keywords/cisco_keywords.txt')
            self.highlighter.load_keywords_from_file(filename)
        elif index == 2:  # Strings Highlighter
            self.highlighter.set_syntax_type("keyword")
