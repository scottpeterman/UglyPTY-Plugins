...
class FileTree(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.current_folder = './'  # or another default directory
        ...
        self.folder_icon = QIcon(os.path.join(current_path, "icons/folder.png"))
        self.folder_open_icon = QIcon(os.path.join(current_path, "icons/folder_open.png"))
        self.file_icon = QIcon(os.path.join(current_path, "icons/file.png"))


        self.load_directory_structure("./")  # Changed this line to use the new method
