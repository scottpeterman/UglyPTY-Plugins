...
import os
import json
from uglyplugin_terminal.Library.winschemahandler import WebEngineUrlSchemeHandler
from uglyplugin_terminal.Library.winshell import Backend
import qdarktheme
...
class Ui_Terminal(QWidget):
    ...
    def setupUi(self, term):
        ...
        terminal_html = os.path.join(current_dir, "qtwincon.html")
