...
from PyQt6.QtCore import QUrl, QMimeData, pyqtSlot, QTimer
from PyQt6.QtWebChannel import QWebChannel

from uglyplugin_ace.Library.editor_handler import Handler
...
class Editor(QtWebEngineWidgets.QWebEngineView):
    def __init__(self, par, doc_text=None):
        ...
        # This will give you the directory of the current module (uglypty in your case).
        # current_directory = os.path.dirname(os.path.abspath(__file__))
        # Build the path to the qtsshcon_light.html file relative to the current module.
        # filename = os.path.join(current_directory, '../ace/editor.html')
        ...
        editor_html_path = os.path.join(parent_path, "ace", "editor.html")
        print(f"loading...{editor_html_path}")
